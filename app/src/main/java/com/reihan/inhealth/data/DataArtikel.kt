...
object DataArtikel {
    ...
    private val titlePopuler = arrayOf(
        "Hal yang perlu Anda lakukan setelah menjalani prosedur operasi jantung",
        "Beberapa penyakit yang bisa menimbulkan gejala berupa sakit tenggorokan",
        "COVID-19 disebabkan oleh SARS-CoV-2, yaitu virus jenis baru dari Coronavirus",
        "Gejala sakit kepala adalah sakit atau nyeri di kepala, yang bisa menyebar ke wajah, leher, dan bahu. "


    )

    private val authorPopuler = arrayOf(
        "Prof. Reihan Fatilla",
        "Dr. Reyhan Akbar",
        "Dr. Fathan Hakim",
        "Muhammad Rafif"
    ...
    private val datePopuler = arrayOf(
        "16 Desember 2021",
        "2 Desember 2021",
        "1 Januari 2021",
        "6 Mei 2021"
    ...
    private val photoPopuler = intArrayOf(
        R.drawable.img_artikel1,
        R.drawable.img_article2,
        R.drawable.img_artikel3,
        R.drawable.img_artikel4
    )

    private val DescPopuler = arrayOf(
        "Berikut ini adalah beberapa hal yang perlu Anda lakukan setelah menjalani prosedur operasi jantung:\n" +
                "\n" +
                "1. Hindari pakaian yang terlalu ketat\n" +
                "Anda disarankan untuk tidak mengenakan pakaian yang terlalu ketat sementara waktu. Hal ini karena pakaian ketat dapat menekan dan bergesekan dengan bekas luka sayatan operasi, sehingga bisa memperlambat proses penyembuhan luka.\n" +
                "\n" +
                "2. Tidak mandi dengan cara berendam \n" +
                "Pada masa pemulihan usai operasi jantung, Anda tidak disarankan untuk mandi dengan cara berendam. Selain itu, hindari mandi dengan air yang terlalu panas atau terlalu dingin.\n" +
                "\n" +
                "3. Perbanyak istirahat\n" +
                "Salah satu efek yang ditimbulkan pascaoperasi jantung adalah sulit tidur dengan nyenyak. Hal ini bisa terjadi lantaran Anda merasakan sakit pada area operasi.\n" +
                "\n" +
                "Untuk mengatasinya, Anda bisa mengonsumsi obat penghilang rasa sakit yang diresepkan oleh dokter sekitar 30 menit sebelum tidur atau melakukan kegiatan yang menenangkan, misalnya mendengarkan musik atau membaca buku.\n" +
                "\n" +
                "Selain itu, hindari pula minuman berkafein yang bisa membuat Anda sulit tidur, seperti kopi, teh, dan minuman bersoda.",
        "Tonsilitis, yaitu peradangan pada amandel atau tonsil\n" +
                ...
                "Apabila Anda mengalami sakit tenggorokan dan memerlukan pemeriksaan COVID-19, klik tautan di bawah ini agar Anda dapat diarahkan ke fasilitas kesehatan terdekat:\n" +
                "\n" +
                "Rapid Test Antibodi\n" +
                "Swab Antigen (Rapid Test Antigen)\n" +
                "PCR\n" +
                "Gejala dan Penyebab Sakit Tenggorokan\n" +
                "Saat mengalami sakit tenggorokan, seseorang bisa merasakan keluhan berupa:\n" +
                "\n" +
                "Tidak nyaman atau nyeri pada tenggorokan\n" +
                "Rasa terbakar di tenggorokan\n" +
                "Sulit menelan\n" +
                "Suara serak\n" +
                "Seperti yang dijelaskan di atas, sakit tenggorokan merupakan gejala dari beragam kondisi atau penyakit. Selain akibat penyakit infeksi, sakit tenggorokan juga bisa disebabkan oleh alergi, penyakit asam lambung, atau tumor di tenggorokan.\n" +
                "\n" +
                "Sakit tenggorokan merupakan salah satu gejala awal dari infeksi virus Corona. Guna memastikan apakah sakit tenggorokan yang dialami merupakan gejala dari virus Corona, diperlukan rapid test atau PCR. Untuk menemukan tempat melakukan rapid test atau PCR di sekitar rumah Anda, klik di sini.\n" +
                "\n" +
                "Pengobatan dan Pencegahan Sakit Tenggorokan\n" +
                "Sakit tenggorokan umumnya dapat diobati dengan banyak minum air dan beristirahat yang cukup. Namun, bila gejala masih berlangsung, segera ke dokter untuk mendapatkan penanganan yang tepat.\n" +
                "\n" +
                "Dokter dapat memberikan obat paracetamol untuk meredakan nyeri di tenggorokan atau meresepkan antibiotik jika sakit tenggorokan disebabkan oleh infeksi bakteri.\n" +
                "\n" +
                "Selain melakukan pengobatan, ada beberapa cara untuk mencegah terjadinya sakit tenggorokan, yaitu:\n" +
                "\n" +
                "Menghindari berbagi perlengkapan makan dan minum dengan orang lain\n" +
        ...
        "Gejala sakit kepala adalah sakit atau nyeri di kepala, yang bisa menyebar ke wajah, leher, dan bahu. Rasa nyeri juga mungkin bisa lebih dominan di bagian kepala tertentu, seperti dahi atau bagian kepala depan, sisi kepala kiri atau kanan, atau belakang kepala. Penglihatan penderita juga dapat menjadi buram, serta lebih sensitif terhadap cahaya dan suara.\n" +
                "\n" +
    ...
    val dataPopuler: ArrayList<Artikel>
        get() {
            val listArtikel = arrayListOf<Artikel>()
            for (position in DataArtikel.titlePopuler.indices) {
                val artikel = Artikel(
                    title = DataArtikel.titlePopuler[position],
                    author = DataArtikel.authorPopuler[position],
                    date = DataArtikel.datePopuler[position],
                    photo = DataArtikel.photoPopuler[position],
                    desc = DataArtikel.DescPopuler[position]
                )
    ...
    private val titleExplore = arrayOf(
        ...
        "Sering Kesemutan? Inilah Beberapa Penyebabnya",
        "10 Manfaat Lidah Buaya untuk Kesehatan",
        "Kenali 7 Manfaat Sambiloto untuk Kesehatan\n"
    )
    ...
    private val DescExplore = arrayOf(
        ...
        "Cara Tradisional Menurunkan Berat Badan\n" +
                ...
                "\n" +
                "3. Minum teh\n" +
                "Teh adalah minuman yang amat sehat karena mengandung antioksidan dan mineral yang cukup tinggi. Banyak studi yang menunjukkan bahwa konsumsi teh, baik teh teh hitam atau teh hijau, dapat meningkatkan pembakaran lemak dan menurunkan berat badan.\n" +
                "\n" +
        ...
        "Tips Menggemukkan Badan yang Tepat\n" +
                "Jika Anda hendak menambah berat badan, lakukan dengan cara yang aman dan sehat. Berikut ini adalah beberapa cara menggemukkan badan secara alami yang dapat Anda terapkan:\n" +
                "\n" +
                "1. Mengonsumsi makanan lebih sering\n" +
                "Apabila berat badan Anda kurang sehingga tampak terlalu kurus, Anda disarankan untuk makan lebih sering. Hal ini bertujuan untuk menambah asupan kalori dan nutrisi yang diperlukan tubuh guna meningkatkan berat badan.\n" +
                "\n" +
                "Jika tidak dapat menghabiskan makanan dalam porsi banyak, cobalah untuk makan dalam porsi sedikit namun lebih sering. Misalnya, dengan meningkatkan frekuensi makan hingga 5 atau 6 kali sehari, tapi dalam porsi yang lebih sedikit.\n" +
                "\n" +
                ...
                "\n" +
                "Makanan tinggi protein dapat meningkatkan massa otot dan menambah berat badan. Sementara itu, karbohidrat dan lemak pada makanan berfungsi untuk menambah jaringan lemak dan mencukupi kebutuhan energi.\n" +
                "\n" +
        ...
        "Apa Penyebab Kesemutan?\\n\" +\n" +
                "                \"Kesemutan ada yang bersifat sementara dan ada pula yang berkepanjangan (parestesia kronis), tergantung penyebab yang mendasarinya. Berikut ini adalah beberapa penyebab kesemutan berdasarkan sifatnya:\\n\" +\n" +
                "                \"\\n\" +\n" +
                ...
                "                \"Cedera saraf\\n\" +\n" +
                "                \"Karena bersifat sementara, kondisi ini bisa mereda dengan sendirinya bila tidak ada lagi tekanan di bagian tubuh. Misalnya, Anda bisa meluruskan kaki setelah duduk bersila. Dengan demikian, aliran darah pun akan kembali lancar.\\n\" +\n" +
                "                \"\\n\" +\n" +
    ...
    val dataExplore: ArrayList<Artikel>
        get() {
            val listArtikel = arrayListOf<Artikel>()
            for (position in DataArtikel.titleExplore.indices) {
                val artikel = Artikel(
                    title = DataArtikel.titleExplore[position],
                    author = DataArtikel.authorExplore[position],
                    date = DataArtikel.dateExplore[position],
                    photo = DataArtikel.photoExplore[position],
                    desc = DataArtikel.DescExplore[position]
                )
                listArtikel.add(artikel)
            }
            return listArtikel
